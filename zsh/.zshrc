...
#
export PATH=$PATH:$HOME/bin:/usr/local/bin:$HOME/.local/bin:$HOME/.config/vifm/scripts:$HOME/code/anki:$HOME/code/misc:$HOME/code/tomates:$HOME
#export PYTHONPATH=$HOME/Documents/scripts/pyfx/ml:$PYTHONPATH esto tenia en la compu vieja
export PYTHONPATH=$PYTHONPATH:$HOME/code:$HOME/code/tomates:$HOME/code/misc:$HOME/code/anki
...
#export FONTCONFIG_FILE=/etc/fonts/ # resuelve slow startup de telegram-desktop
...
export chat=$HOME/pdfs/chatgpt3
export lsd=$HOME/lsd
